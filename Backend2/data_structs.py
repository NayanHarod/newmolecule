...
class MolData(Dataset):
    ...
    def collate_fn(cls, arr):
        ...
        collated_arr = utils.Variable(torch.zeros(len(arr), max_length))
...
class Experience(object):
    ...
    def sample(self, n):
        ...
        encoded = [utils.Variable(self.voc.encode(tokenized_i)) for tokenized_i in tokenized]
...
def construct_vocabulary(smiles_list):
    ...
    with open('Prediction_and_Training/Voc', 'w') as f:
